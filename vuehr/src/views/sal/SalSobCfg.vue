<template>
    <div>
        <div>
            <el-table style="font-family: 华文行楷" :data="emps" border stripe size="mini">
                        ...
                        <el-popover
                            ...
                            <div>
                                ...
                                <div style="margin-top: 10px;display: flex;justify-content: center">
                                    <el-button size="mini"  type="primary" @click="updateSal(scope.row)">确定数据更新</el-button>
                                </div>
                            </div>
                            <el-button slot="reference" type="danger">工资账套の修改</el-button>
                        </el-popover>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    export default {
        ...
        methods: {
            ...
            //初始化账套数据
            initSalaries() {
                this.getRequest("/salary/sobcfg/salies").then(resp => {
                    if (resp) {
                        this.salaries = resp;
                    }
                })
