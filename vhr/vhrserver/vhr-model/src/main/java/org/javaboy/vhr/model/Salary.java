...
public class Salary {
    ...
    public Salary(Integer id, Integer basicSalary, Integer bonus, Integer lunchSalary, Integer trafficSalary, Integer allSalary, Integer pensionBase, Float pensionPer, Date createDate, Integer medicalBase, Float medicalPer, Integer accumulationFundBase, Float accumulationFundPer, String name) {
        this.id = id;
