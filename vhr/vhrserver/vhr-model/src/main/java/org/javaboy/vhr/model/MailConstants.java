...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "littleSun.mail.welcome.queue";
    public static final String MAIL_EXCHANGE_NAME = "littleSun.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "littleSun.mail.routing.key";
}
